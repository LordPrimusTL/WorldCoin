...
<?php $__env->startSection('body'); ?>
    <div class="" style="margin-top:30px;">
        <div class="row">
            ...
            <?php if($with): ?>
                <a href="<?php echo e(url('/admin/with-status/0')); ?>" class="btn btn-success"><span class="glyphicon glyphicon-check"></span>&nbsp;Withdrawal Is On</a>
            <?php else: ?>
                <a href="<?php echo e(url('/admin/with-status/1')); ?>" class="btn btn-danger"><span class="glyphicon glyphicon-off"></span>&nbsp;Withdrawal Is Off</a>
            <?php endif; ?>
            <div class="col-lg-12">
                    ...
                    <?php $__currentLoopData = $transs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="alert-warning">
                                ...
                                <td>
                                    <?php if($trans->tn_id == 1): ?>
                                        ...
                                        <a class="btn btn-info" href="<?php echo e(url('/admin/trade/cancel/'.$trans->t_id)); ?>"><span class="glyphicon glyphicon-trash"></span>&nbsp; Delete</a>
                                    <?php elseif($trans->tn_id == 2 || $trans->tn_id == 4): ?>
                                        <a class="btn btn-info" href="<?php echo e(url('/admin/withdrawal/approve/'.$trans->t_id)); ?>"><span class="glyphicon glyphicon-check"></span>&nbsp; Approve</a>
                                        <a class="btn btn-info" href="<?php echo e(url('/admin/withdrawal/cancel/'.$trans->t_id)); ?>"><span class="glyphicon glyphicon-trash"></span>&nbsp; Delete</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        ...
                        <?php elseif($trans->ts_id == 7): ?>
                            <tr style="background-color: #cbb956">
                                ...
                                <td><?php echo e('$'.$trans->current_balance); ?></td>
                                <td>
                                    <a class="btn btn-success" href="<?php echo e(url('/admin/withdrawal/complete/'.$trans->t_id)); ?>"><span class="glyphicon glyphicon-check"></span>&nbsp; Completed</a>
                                </td>
                            </tr>
                        <?php endif; ?>

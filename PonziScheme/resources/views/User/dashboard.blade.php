...
@section('body')
    <div class="container" style="margin-top:30px;">
        <div class="row">
            <div class="col-lg-4">
                <a href="{{url('/user/profile')}}" style="text-decoration:none;color:white;">
            ...
            <div class="col-lg-4">
                <a href="{{url('/user/invest')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:skyblue;">
                        <div class="panel-heading">
        ...
        <div class="row">
            <div class="col-lg-4">
                @if($with == true)
                    <a href="{{url('/user/withdrawals')}}" style="background-color:green;text-decoration:none;color:white;">
                        <div class="panel" style="background-color:skyblue;">
                ...
                @else
                    <a href="{{url('/user/withdrawals')}}" style="background-color:red;text-decoration:none;color:white;">
            ...
            <div class="col-lg-4">
                <a href="{{url('/user/transactions')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:skyblue;">
                        <div class="panel-heading">
            ...
            <div class="col-lg-4">
                <a href="{{url('/user/referral')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:skyblue;">
                        <div class="panel-heading">
            ...
            <div class="col-lg-4">
                <a href="{{url('/user/tickets')}}"  style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:skyblue;">
                        <div class="panel-heading">
